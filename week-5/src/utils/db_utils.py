...
load_dotenv(dotenv_path=r"C:\Users\Gen-UK-Student\Documents\Projects\local-cafe-etl\week-5\docker\.env") #replcae with your file path
...
def populate_database(conn, cursor):
    with open(r"C:\Users\Gen-UK-Student\Documents\Projects\local-cafe-etl\week-5\docker\tables.sql", 'r') as tables_sql: #replcae with your file path
