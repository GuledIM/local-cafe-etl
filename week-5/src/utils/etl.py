...
def load_to_db(conn, cursor, branches, transactions, products):
    """
    Saving to Database. 
    """
...
def load(conn, cursor, df):
    ...
    branches, transactions, products = normalisation(df)
    
    load_to_db(conn, cursor, branches, transactions, products)